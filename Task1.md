...
* Сгенерируйте ключи для jump-node с помощью команды `ssh-keygen`
...
* Сгенерируйте ключи с помощью команды `ssh-keygen`, и запишите их, предварительно просмотрев с помощью команды `cat .ssh/id_ed25519.pub`
